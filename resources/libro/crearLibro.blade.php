                ...
                <div class="card shadow-lg p-3 mb-5 bg-white ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('Libro.save')}}" method="POST" enctype="multipart/form-data" class="alerta">
                            ...
                            <div class="col-md-5  p-4 offset-1">
                                <div class="input-group ">
                                    <label  class="input-group-text " for="inputGroupSelect01">Casa Editorial</label>
                                    <select name="casa_editorial_id" class="form-select" id="inputGroupSelect01">
                                        <option class="align-self-center text-center" > Seleccione </option>

                                        @foreach($casa_editorial as $casa_editorials)
                                            <option value="{{$casa_editorials->id}}"> {{$casa_editorials->nombre_casa}}  </option>
                                        @endforeach
